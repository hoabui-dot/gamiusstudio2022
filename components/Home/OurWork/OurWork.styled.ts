...
export const WrapperSwiper = styled.div`
  ...
  .mySwiper {
    ...
    position: unset;
    ${tw`sm:w-[70vw] w-[90vw] max-w-[1065px] h-auto border-[3px] border-green rounded-t-[30px] border-b-0`}
...
export const TitleSwiper = styled.div`
  ${tw`bg-green text-center text-black font-bold rounded-b-[30px] lg:text-[24px] text-[16px] `}
`;
