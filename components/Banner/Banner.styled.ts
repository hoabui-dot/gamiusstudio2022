...
export const BannerSubTitle = styled.p`
    ${tw`text-xs xl:text-2xl 2xl:w-[584px] sm:text-sm xl:w-[470px] 
...
export const BannerIcon = styled.div`
    ...
    2xl:left-[-15.5%] xl:left-[-19%] lg:left-[-16%] z-50 md:w-[50px] md:left-[-17%] 
    md:bottom-[-16%] w-[40px] left-[-24%] bottom-[12%]`}
`

export const BannerStatus = styled.ul`
    ${tw`absolute flex top-[40%] right-[13%] z-[70]`}
`

export const Sticked = styled.li`
    ${tw`relative w-[17px] h-[23px] z-[90]`}
`
